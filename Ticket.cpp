...
void reservation(string name,int seatNumber,char seatType)
{
    if(seatNumber<1&&seatNumber>20){
        ...
        switch(seatType){
            case 'F':
                if((seatNumber<=5)&&(seats[seatNumber-1].isReservation==false))
                {
                    ...
                    printError();
            case 'E':
                if((seatNumber<=20)&&(seats[seatNumber+4].isReservation==false))
                {
